...
import SectionHead from "~/app/_components/dashboard/SectionHead";
import StatTile from "~/app/_components/dashboard/StatTile";
...
export default function DashboardPage() {
    const { state, activeProjects, limit, markRead, go, openAddClient } =
        useEzlane();
