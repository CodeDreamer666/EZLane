        ...
        <div className="mx-auto grid max-w-[1080px] grid-cols-[minmax(0,_1fr)_minmax(0,_1.05fr)] items-center gap-14 max-[820px]:grid-cols-1 max-[820px]:gap-[30px]">
          <div>
            ...
            <div className="mt-[30px] flex flex-wrap gap-3">
              ...
              <a
                href="#how"
                className="font-heading text-text/78 hover:text-text border-divider hover:bg-text/7 rounded-md border px-[18px] py-[11px] text-[14px] font-semibold"
              >
                See how it works
              </a>
            </div>
            <div className="text-text/45 mt-[18px] text-[12.5px]">
              Free for 2 active projects. No card needed.
            </div>
          </div>
